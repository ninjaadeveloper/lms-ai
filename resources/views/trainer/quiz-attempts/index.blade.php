...
<section class="section">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="card card-statistic-1">
        <div class="card-icon bg-danger"><i class="fas fa-chart-line"></i></div>
        <div class="card-wrap">
          <div class="card-header"><h4>Avg Attempts</h4></div>
          <div class="card-body">
            ...
            <table class="table table-striped table-hover mb-0">
              ...
              @forelse($quizzes as $i => $quiz)
                <tr style="cursor:pointer"
                    onclick="window.location='{{ route('trainer.quiz.attempts.show', $quiz->id) }}'">
                  ...
                  <td class="text-center" onclick="event.stopPropagation();">
                    <a href="{{ route('trainer.quiz.attempts.show', $quiz->id) }}"

    ...
    Clear
            ...
            <div class="card shadow-sm">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a id="pdfBtn" href="{{ route('trainer.reports.export.pdf', ['type' => 'courses']) }}"
...
function loadData() {
    ...
    fetch("{{ route('trainer.reports.type','courses') }}?" + params, {
        headers: {
    ...
    .then(res => {
        ...
        pdfBtn.href = "{{ route('trainer.reports.export.pdf',['type'=>'courses']) }}?" + params;
    });
}

        ...
        <section class="section">
            ...
            <div class="card shadow-sm mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a id="pdfBtn" href="{{ route('admin.reports.export.pdf', ['type' => 'quiz']) }}"
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <tbody id="reportTable">
                                @include('admin.reports.partials.quiz-table', ['reports' => $reports])
                            </tbody>
                        </table>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadReport(query) {
        fetch("{{ route('admin.reports.index') }}?" + query, {
            headers: {
        ...
        .then(data => {
            ...
            document.getElementById('stat-pass').innerText = data.stats.pass_percent + '%';
            document.getElementById('stat-fail').innerText = data.stats.fail_percent + '%';

            document.getElementById('pdfBtn').href =
                "{{ route('admin.reports.export.pdf', ['type' => 'quiz']) }}?" + query;
        })
